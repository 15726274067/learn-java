...
public class MyAspect {
     ...
     * • *表示任意返回类型的方法：
     * • com.zhutao.aop.service.impl.HelloServiceImpl 指定目标对象的全限定名称
     * • printUser 指定目标对象的方法
     * • (..) 表示任意参数进行匹配。
     */
    @Pointcut("execution(* com.zhutao.aop.service.impl.HelloServiceImpl.print(..) )")
     ...
     */
    @DeclareParents(value = "com.zhutao.aop.service.impl.HelloServiceImpl",
